...
<table class="easyui-datagrid" id="itemList" title="商品列表" 
       data-options="singleSelect:false,collapsible:true,pagination:true,url:'/manager/getitemList.action',method:'get',pageSize:30,toolbar:toolbar">
    <thead>
        <tr>
    ...
    var toolbar = [{
        ...
        handler:function(){
        	...
        	$.messager.confirm('确认','确定删除ID为 '+ids+' 的商品吗？',function(r){
        	    if (r){
        	    	var params = {"ids":ids};
                	$.post("/rest/item/delete.action",params, function(data){
            			if(data.status == 200){
        ...
        handler:function(){
        	...
        	$.messager.confirm('确认','确定下架ID为 '+ids+' 的商品吗？',function(r){
        	    if (r){
        	    	var params = {"ids":ids};
                	$.post("/rest/item/instock.action",params, function(data){
            			if(data.status == 200){
        ...
        handler:function(){
        	...
        	$.messager.confirm('确认','确定上架ID为 '+ids+' 的商品吗？',function(r){
        	    if (r){
        	    	var params = {"ids":ids};
                	$.post("/rest/item/reshelf.action",params, function(data){
            			if(data.status == 200){
