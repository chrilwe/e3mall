    ...
    <ul class="fr topTh">
      <li class="login" id="login">
      	<span id="loginbar" style="margin-right: 15px;">
	      	<a href="http://login.e3mall.club/user/loginPage/?returnUrl=http://www.e3mall.club/">请登录</a>
      	</span>
      	<a href="http://login.e3mall.club/registerPage/?returnUrl=http://www.e3mall.club/">免费注册</a>
      </li>
      <!--<li id='qiyeLogin'><a href='http://www.sfme.me/login.jhtml' target='_blank' rel='nofollow'>员工福利</a></li>-->
      <li class="myOrder"><a name="sfbest_hp_hp_head_OrderList" class="trackref" href="http://order.e3mall.cn/myorder/index/" rel="nofollow">我的订单</a></li>
      <li class="menus">
