...
<div class="slide_show" id="slide_show">
	<div class="indexW">
      <div id="index_slide" class="slide_wrap">
		<ol id="ad1Pic">
			<c:forEach items="${contents}" var="node" varStatus="status">
			<li>
     ...
     <div class="rSide">	
      ...
      <!-- <li class="cur">1</li><li class="">2</li><li class="">3</li><li class="">4</li> -->
      			<c:forEach items="${contents}" varStatus="status">
